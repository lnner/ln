## 1. 准备
	...
	3.Object.defineProperty(obj, propertyName, {}): 给对象添加/修改属性(指定描述符)
		configurable: true/false  是否可以重新define---默认为false
		enumerable: true/false 是否可以枚举(for..in / keys())---默认为false
		value: 指定初始值
		writable: true/false value是否可以修改存取(访问)描述符---默认为false
		get: 函数, 用来得到当前属性值
		set: 函数, 用来监视当前属性值的变化
  	4.Object.keys(obj): 得到对象自身可枚举的属性名的数组**仅为属性名**
